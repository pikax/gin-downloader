...
exports.processFilter = function (filter) {
    ...
    var methodRating = "eq";
    if (search) {
        var name = search.name, author_1 = search.author, artist_1 = search.artist, rating_1 = search.rating, released = search.released, type_1 = search.type;
        ...
        if (rating_1) {
            filterRating = rating_1.value || filterRating;
            methodRating = searchMethod(rating_1.condition) || methodRating;
        }
        if (released) {
