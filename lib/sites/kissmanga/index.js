...
var requestCloudFareStrategy_1 = require("../../request/requestCloudFareStrategy");
var KissManga = (function (_super) {
    __extends(KissManga, _super);
    function KissManga() {
        return _super.call(this, config_1.config, new parser_1.Parser(), new names_1.Helper(), requestCloudFareStrategy_1.strategy) || this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request.postDoc(opts)];
                    case 1:
                        doc = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        chapters = _a.sent();
                        chapter = lodash_1.find(chapters, { chap_number: chapNumber });
                        if (!chapter) {
