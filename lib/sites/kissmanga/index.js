            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request.postDoc(search.src, search.params)];
                    case 1:
                        doc = _a.sent();
                        return [4 /*yield*/, this.parser.mangas(doc)];
                    case 2:
                        mangas = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        html = _a.sent();
                        secret = Parser.getSecret(html);
                        return [4 /*yield*/, this.getVM()];
                    case 3:
                        vm = _a.sent();
                        imgs = Parser.imagesList(html, secret, vm);
