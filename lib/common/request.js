...
exports.getHtml = function (requestedPath, params) {
...
var RequestBytes = function (requestedPath, params, method) {
    verbose("Request: %s : %o", requestedPath, params);
    var uri = url.parse(requestedPath);
    var p = uri.pathname;
    // fix the path
    var paths = p.split("/").map(encodeURIComponent);
    var requestedUrl = url.format(uri).replace(p, paths.join("/"));
...
exports.postBytes = function (requestedPath, params) {
    return RequestBytes(requestedPath, params, "POST");
};
exports.postHtml = function (requestedPath, params) { return __awaiter(_this, void 0, void 0, function () {
    var bytes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.postBytes(requestedPath, params)];
            case 1:
                bytes = _a.sent();
                return [2 /*return*/, bytes.toString()];
        }
...
exports.postDoc = function (requestedPath, params) {
    return exports.postHtml(requestedPath, params).then(function (x) { return helper_1.parseDoc(x, { location: requestedPath }); });
};
exports.request = {
    getBytes: exports.getBytes,
    getHtml: exports.getHtml,
    getDoc: exports.getDoc,
    postBytes: exports.postBytes,
    postHtml: exports.postHtml,
    postDoc: exports.postDoc,
};
