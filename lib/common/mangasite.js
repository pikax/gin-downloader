...
var MangaSite = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, helper_1.getDoc(this.config.latest_url).then(this.parser.latest)];
                    case 1:
                        mangas = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, helper_1.getDoc(src).then(this.parser.info)];
                    case 2:
                        info = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        src = this.nameHelper.resolveUrl(name);
                        return [4 /*yield*/, helper_1.getDoc(src).then(this.parser.chapters)];
                    case 2:
                        chapters = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        src = this.nameHelper.resolveUrl(name);
                        return [4 /*yield*/, helper_1.getDoc(src)];
                    case 2:
                        doc = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        chap = _a.sent();
                        return [4 /*yield*/, helper_1.getDoc(chap).then(this.parser.imagesPaths)];
                    case 2:
                        paths = _a.sent();
                        return [2 /*return*/, paths.map(function (x) { return MangaSite.processImagePath(x, _this.parser); })];
                }
            });
        });
    };
    ...
    MangaSite.processImagePath = function (src, parser) {
        return __awaiter(this, void 0, void 0, function () {
            var image;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request_1.getHtml(src).then(parser.image)];
                    case 1:
                        image = _a.sent();
                        return [2 /*return*/, {
