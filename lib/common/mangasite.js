...
var MangaSite = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        paths = _a.sent();
                        return [2 /*return*/, paths.map(function (x) { return MangaSite.processImagePath(_this.buildImagePathsRequest(x), _this.parser, _this.request); })];
                }
            });
        });
    };
    ...
    MangaSite.processImagePath = function (opts, parser, request) {
        return __awaiter(this, void 0, void 0, function () {
            var image;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.getHtml(opts).then(parser.image)];
                    case 1:
                        image = _a.sent();
                        return [2 /*return*/, {
